...
<div class="flakes" style="background-image:url('media/final-asset/leaf_background.png')">
    ...
    <div class="internal-features m-side">
        ...
        <div class="first-icon-row">
            <div class="icon-box">
                <div class="icon-box-over">
                    <div class="icon">
                        <img src="media/Icons/ONLINE + OFFLINE.svg" alt="">
                    </div>
                    <div class="icon-name">
                        <p>Online - Offline</p>
                    </div>
            ...
            <div class="icon-box">
                <div class="icon-box-over">
                    <div class="icon">
                        <img src="media/Icons/CONVIENENT SLOTS.svg" alt="">
                    </div>
                    <div class="icon-name">
                        <p>Convinient Slots</p>
                    </div>
                </div>
            </div>
            <div class="icon-box">
                <div class="icon-box-over">
                    <div class="icon">
                        <img src="media/Icons/JOIN ANYTIME.svg" alt="">
                    </div>
                    <div class="icon-name">
                        <p>Join Anytime</p>
                    </div>
        ...
        <div class="icon-box">
                <div class="icon-box-over">
                    <div class="icon">
                        <img src="media/Icons/ACCELERATED LEARNING.svg" alt="">
                    </div>
                    <div class="icon-name">
                        <p>Accelarated Learning</p>
                    </div>
                </div>
            </div>
            <div class="icon-box">
                <div class="icon-box-over">
                    <div class="icon">
                        <img src="media/Icons/DOWNLOAD CONTENT.svg" alt="">
                    </div>
                    <div class="icon-name">
            ...
            <div class="icon-box">
                <div class="icon-box-over">
                    <div class="icon">
                        <img src="media/Icons/interactive session.svg" alt="">
                    </div>
                    <div class="icon-name">
...
<div class="contact-form m-def m-side">
    ...
    <form class="m-side">
        ...
        <button type="submit" class="btn contact-btn m-auto">Submit</button>
    </form>
</div>
