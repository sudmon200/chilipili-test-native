...
<section class="container-fluid about-top">
	<div class="row">
		...
		<div class="col-lg-6 col-md-6 col-12" color="blue">
...
<section class="container about-background" style="background-image: url('media/final-asset/wave-3.svg')">
	...
	<p>We understand that learning is not about what you teach, or how much you teach but it is about how you teach. How
		...
		principles are straightforward, the child learns holistically, develops all round into a better human being
		while being as involved and self-driven in the process as possible.</p>
		...
		<div class="card col-lg-4 col-md-6 col-12 mb-1">
			...
			<div class="card-body">
				...
				<p class="card-text">An inventor and entrepreneur, Suhas holds 6 US patents in addition to multiple
					...
					Semi-conductor industry. He founded Chilli-Pilli pre schools and<span id="dots1">.....</span><span
						id="more1"> invented the Chilli-pilli phonics system for language training .Work Exp: MGTS (Texas
		...
		<div class="card col-lg-4 col-md-6 col-12 mb-1">
			...
			<div class="card-body">
				...
				<p class="card-text">Deepak is highly effective Leadership developer with over 15 year of experience
					...
					effectiveness program and managing multi-disciplined function.<span id="dots2">.....</span><span
						id="more2"> Work Exp: Sr. Operations Manager (Convergys India services) Management Consultant
		...
		<div class="card col-lg-4 col-md-6 col-12 mb-1">
			...
			<div class="card-body">
				...
				<p class="card-text">Passionate about entrepreneurship, Arun had worked across industries including real
					...
					practice as a consultants for budding entrepreneurs in<span id="dots3">.....</span><span
						id="more3"> developing ideas into viable business plans. Work Exp: Young Leader:Brand Management
