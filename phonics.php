...
<section class="phonics-bg" style="background-image: url(media/final-asset/phonics_wave-01.png);">
	...
	<div class="phonics-main m-side m-top">
		...
		<p class="font3">Phonics is a sound based to teach reading and writing. The principle is that sounds made by
			letters in a word combine in particular ways to generate the sound the word makes.
