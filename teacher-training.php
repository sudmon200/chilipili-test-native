    ...
    <div class="m-side internal-header">
        <div class="side1">
            <div class="section-head">
                <h4 class="font1 internal-head">Why is Teachers' Training important ?</h4>
            </div>
        ...
        <div class="side2">
            <img src="media/Image1b_TT-min.png" class="teacher-img" alt="Montessori-leaf">
        </div>
    </div>
...
<div class="flakes" style="background-image:url('media/final-asset/leaf_background.png')">
    ...
    <div class="internal-features m-def m-side">
        ...
        <div class="first-icon-row">
            <div class="icon-box">
                <div class="icon-box-over">
                    <div class="icon">
                        <img src="media/Icons/NTT certificate.svg" alt="certification">
                    </div>
                    <div class="icon-name">
                        <p>NTT Certification</p>
                    </div>
                </div>
            </div>
            <div class="icon-box">
                <div class="icon-box-over">
                    <div class="icon">
                        <img src="media/Icons/trainer icon.svg" alt="experienced-trainers">
                    </div>
                    <div class="icon-name">
            ...
            <div class="icon-box">
                <div class="icon-box-over">
                    <div class="icon">
                        <img src="media/Icons/pedagogies.svg" alt="innovative">
                    </div>
                    <div class="icon-name">
                        <p>Innovative Pedogogies</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="icon-box">
                <div class="icon-box-over">
                    <div class="icon">
                        <img src="media/Icons/produvtive icon.svg" alt="prod-tools">
                    </div>
                    <div class="icon-name">
                        <p>Productivity Tools Training</p>
                    </div>
                </div>
            </div>
            <div class="icon-box">
                <div class="icon-box-over">
                    <div class="icon">
                        <img src="media/Icons/soft skill.svg" alt="soft-skills">
                    </div>
                    <div class="icon-name">
            ...
            <div class="icon-box">
                <div class="icon-box-over">
                    <div class="icon">
                        <img src="media/Icons/potential energy.svg" alt="creative-potential">
                    </div>
                    <div class="icon-name">
                        <p>Building Creative Potential</p>
                    </div>
                </div>
            </div>
        </div>
